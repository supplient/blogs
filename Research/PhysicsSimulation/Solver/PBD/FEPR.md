...
设系统总势能为$E(x)$，系统总动能为$\frac{1}{2}||v||^2_M$，系统机械能为$H(x,v)=E(x) + \frac{1}{2}||v||^2_M$。其中$||v||^2_M=v^TMv$。这里动能的表示我一开始看不太懂，乘开来以后其实就是每个粒子的动能和。
